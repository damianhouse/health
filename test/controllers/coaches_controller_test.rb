...
class CoachesControllerTest < ActionController::TestCase
  ...
  test "should create coach" do
    assert_difference('Coach.count') do
      post :create, coach: { email: @coach.email, name: @coach.name, password_digest: @coach.password_digest, role: @coach.role }
    end
  ...
  test "should update coach" do
    patch :update, id: @coach, coach: { email: @coach.email, name: @coach.name, password_digest: @coach.password_digest, role: @coach.role }
    assert_redirected_to coach_path(assigns(:coach))
  end
